...
# Script is in backend/app/scripts/, so we need to go up 2 levels to get to backend/
...
# Delay chromadb import to avoid Pydantic compatibility issues
...
async def seed_mock_data():
    ...
    try:
        # Import chromadb here to avoid Pydantic compatibility issues
        import chromadb
        ...
        # Initialize embeddings model (already imported above)
